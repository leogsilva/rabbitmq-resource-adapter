...
/**
 * RabbitmqManagedConnectionMetaData
 *
 * @version $Revision: $
 */
...
{
   /** The logger */
   private static Logger log = Logger.getLogger(RabbitmqManagedConnectionMetaData.class.getName());

   /**
    * Default constructor
    */
   public RabbitmqManagedConnectionMetaData()
   {
