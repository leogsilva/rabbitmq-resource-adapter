...
public class RabbitmqManagedConnection implements ManagedConnection {
  ...
  /** The logger */
  private static Logger log = Logger.getLogger(RabbitmqManagedConnection.class
      .getName());
  ...
  /** Connection */
  private RabbitmqConnectionImpl connection;
  ...
  public RabbitmqManagedConnection(RabbitmqManagedConnectionFactory mcf)
    ...
    try {
      this.rabbitConnection = mcf.getRabbitConnectionFactory().newConnection();
  ...
  public Object getConnection(Subject subject,
    ...
    connection = new RabbitmqConnectionImpl(this, mcf);
    return connection;
  }
  ...
  public void associateConnection(Object connection) throws ResourceException {
    ...
    this.connection = (RabbitmqConnectionImpl) connection;
  }
